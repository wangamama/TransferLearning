    ...
    def _stage2_adaboostR2(self, iboost, X, y, sample_weight):
        ...
        if not iboost == self.n_estimators - 1:
            sample_weight[-self.sample_size[-1]:] *= np.power(
                beta,(error_vect[-self.sample_size[-1]:]) * self.learning_rate)
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        for istep in range(self.steps):
            model = Stage2_TrAdaBoostR2(self.base_estimator,
                                        ...
                                        random_state=self.random_state,margin=self.margin)
...
# 4.2 TwoStageAdaBoostR2 without margin
regr_3 = TwoStageTrAdaBoostR2(DecisionTreeRegressor(max_depth=6),
                              n_estimators=n_estimators, sample_size=sample_size,
                              steps=steps, fold=fold,
                              random_state=random_state,margin=False)
regr_3.fit(X, y)
...
mse_twostageboost3 = mean_squared_error(y_target_test, y_pred3)
print("MSE of regular AdaboostR2:", mse_adaboost)
print("MSE of TwoStageTrAdaboostR2:", mse_twostageboost)
print("MSE of TwoStageTrAdaboostR2 without margin:", mse_twostageboost3)
# ==============================================================================
print("r2 of regular AdaboostR2:", r2_score(y_target_test, y_pred2))
print("r2 of TwoStageTrAdaboostR2:", r2_score(y_target_test, y_pred1))
print("r2 of TwoStageTrAdaboostR2 without margin:", r2_score(y_target_test, y_pred3))
...
# plt.scatter(x_target_train, y_target_train, c="k", label="target_train")
# plt.plot(x_target_test, y_target_test, c="b", label="target_test", linewidth=0.5)
# plt.plot(x_target_test, y_pred1, c="r", label="VFKMM-TrAdaBoost", linewidth=2)
# plt.plot(x_target_test, y_pred2, c="y", label="AdaBoostRegressor", linewidth=2)
# plt.plot(x_target_test, y_pred3, c="g", label="VFKMM-TrAdaBoost without margin", linewidth=2)
# plt.xlabel("x")
# plt.ylabel("y")
